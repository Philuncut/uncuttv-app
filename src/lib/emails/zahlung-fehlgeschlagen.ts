...
<head>
  ...
  <title>Zahlung fehlgeschlagen – UncutTV</title>
</head>
    ...
    <tr>
      <td align="center">
        <table width="100%" style="max-width:560px;">
          ...
          <!-- Card -->
          <tr>
            <td style="background:#1a1a1a;border:1px solid rgba(229,9,20,0.3);padding:40px 40px 32px;">

              <!-- Red top bar -->
              <div style="height:3px;background:#E50914;box-shadow:0 0 20px rgba(229,9,20,0.8);margin-bottom:32px;"></div>
              ...
              <p style="font-size:0.92rem;color:#9ca3af;line-height:1.8;margin:0 0 24px 0;">
                Deine monatliche Zahlung für UncutTV konnte leider nicht verarbeitet werden. Bitte aktualisiere deine Zahlungsmethode, um weiter Zugang zu allen Inhalten zu behalten.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);margin-bottom:32px;">
                <tr>
                  <td style="padding:16px 20px;">
                    <p style="font-size:0.72rem;letter-spacing:0.1em;color:#9ca3af;margin:0 0 10px 0;text-transform:uppercase;">Was passiert jetzt?</p>
                    <p style="font-size:0.82rem;color:#6b7280;line-height:2;margin:0;">
                      ① Stripe versucht die Zahlung automatisch erneut<br/>
                      ② Aktualisiere deine Karte um sofortigen Zugang zu behalten<br/>
                      ③ Nach erfolgreicher Zahlung wird dein Zugang wiederhergestellt
                    </p>
                  </td>
                </tr>
              </table>
